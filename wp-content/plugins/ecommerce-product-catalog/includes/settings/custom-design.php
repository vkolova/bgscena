		...
		<form method="post" action="options.php">
			...
			<table class="design-table">
				...
				<tbody>
					...
					<tr><td class="additional-styling"><strong><?php _e( 'Additional Settings', 'ecommerce-product-catalog' ); ?></strong><br><input title="<?php _e( 'Use this only with short attributes labels and values e.g. Color: Red', 'ecommerce-product-catalog' ) ?>" type="checkbox" name="modern_grid_settings[attributes]" value="1"<?php checked( 1, isset( $modern_grid_settings[ 'attributes' ] ) ? $modern_grid_settings[ 'attributes' ] : ''  ); ?>><?php _e( 'Show Attributes', 'ecommerce-product-catalog' ); ?><br><?php _e( 'Per row', 'ecommerce-product-catalog' ) ?>: <input type="number" min="1" max="5" step="1" class="number_box" name="modern_grid_settings[per-row]" value="<?php echo $modern_grid_settings[ 'per-row' ] ?>"><?php _e( 'products', 'ecommerce-product-catalog' ) ?></td></tr>
					...
					<tr>
						<td class="additional-styling"><strong><?php _e( 'Additional Settings', 'ecommerce-product-catalog' ); ?></strong><br><?php _e( 'Per row', 'ecommerce-product-catalog' ) ?>: <input type="number" min="1" step="1" class="number_box" title="<?php _e( 'The product listing element width will adjust accordingly to your theme content width.', 'ecommerce-product-catalog' ) ?>" name="classic_grid_settings[entries]" value="<?php echo $classic_grid_settings[ 'entries' ] ?>"><?php _e( 'products', 'ecommerce-product-catalog' ) ?></td>
					</tr>
					<tr><td colspan="2" class="separator"></td></tr>
...
function single_custom_design() {
	...
	if ( $submenu == 'single-design' ) {
		...
		<form method="post" action="options.php">
			...
			<input type="checkbox" title="<?php _e( 'The image will be used only for product listing when unchecked.', 'ecommerce-product-catalog' ) ?>" name="multi_single_options[enable_product_gallery]" value="1"<?php checked( 1, isset( $single_options[ 'enable_product_gallery' ] ) ? $single_options[ 'enable_product_gallery' ] : ''  ); ?>><?php _e( 'Enable product image', 'ecommerce-product-catalog' ); ?></br>
			...
			<input type="checkbox" title="<?php _e( 'The default image will be used on product listing only when unchecked.', 'ecommerce-product-catalog' ) ?>" name="multi_single_options[enable_product_gallery_only_when_exist]" value="1"<?php checked( 1, isset( $single_options[ 'enable_product_gallery_only_when_exist' ] ) ? $single_options[ 'enable_product_gallery_only_when_exist' ] : ''  ); ?> /><?php
