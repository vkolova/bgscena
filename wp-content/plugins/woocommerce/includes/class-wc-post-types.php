	...
	public static function register_taxonomies() {
		...
		register_taxonomy( 'product_cat',
			...
			apply_filters( 'woocommerce_taxonomy_args_product_cat', array(
				...
				'label'                 => __( 'Категории', 'woocommerce' ),
				'labels' => array(
						'name'              => __( 'Категории', 'woocommerce' ),
						'singular_name'     => __( 'Категории', 'woocommerce' ),
						'menu_name'         => _x( 'Categories', 'Admin menu name', 'woocommerce' ),
						'search_items'      => __( 'Търси в категории', 'woocommerce' ),
						'all_items'         => __( 'Всички категории', 'woocommerce' ),
						'parent_item'       => __( 'Родителска категория', 'woocommerce' ),
						'parent_item_colon' => __( 'Parent Product Category:', 'woocommerce' ),
						'edit_item'         => __( 'Редактирай категорията', 'woocommerce' ),
						'update_item'       => __( 'Update Product Category', 'woocommerce' ),
						'add_new_item'      => __( 'Добави нова категория', 'woocommerce' ),
		...
		register_taxonomy( 'product_tag',
			...
			apply_filters( 'woocommerce_taxonomy_args_product_tag', array(
				'hierarchical'          => false,
				'update_count_callback' => '_wc_term_recount',
				'label'                 => __( 'Етикети', 'woocommerce' ),
				'labels'                => array(
						'name'                       => __( 'Етикети', 'woocommerce' ),
						'singular_name'              => __( 'Етикет', 'woocommerce' ),
						...
						'add_new_item'               => __( 'Добави нов етикет', 'woocommerce' ),
						'new_item_name'              => __( 'Име на нов етикет', 'woocommerce' ),
	...
	public static function register_post_types() {
		...
		register_post_type( 'product',
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							'name'                  => __( 'Постановки', 'woocommerce' ),
							'singular_name'         => __( 'Постановка', 'woocommerce' ),
							'menu_name'             => _x( 'Постановки', 'Admin menu name', 'woocommerce' ),
							'add_new'               => __( 'Добави постановка', 'woocommerce' ),
							'add_new_item'          => __( 'Добави нова постановка', 'woocommerce' ),
							'edit'                  => __( 'Edit', 'woocommerce' ),
							'edit_item'             => __( 'Редактирай постановка', 'woocommerce' ),
							'new_item'              => __( 'Добави постановка', 'woocommerce' ),
							'view'                  => __( 'Виж постановка', 'woocommerce' ),
							'view_item'             => __( 'Виж постановка', 'woocommerce' ),
							'search_items'          => __( 'Търси  постановки', 'woocommerce' ),
							'not_found'             => __( 'Не са намерени постановки', 'woocommerce' ),
							'not_found_in_trash'    => __( 'No Products found in trash', 'woocommerce' ),
							'parent'                => __( 'Parent Product', 'woocommerce' ),
							'featured_image'        => __( 'Изображение на постановката', 'woocommerce' ),
							'set_featured_image'    => __( 'Сложи изображение', 'woocommerce' ),
							'remove_featured_image' => __( 'Премахни изображение', 'woocommerce' ),
							'use_featured_image'    => __( 'Използвай като изображение', 'woocommerce' ),
						),
