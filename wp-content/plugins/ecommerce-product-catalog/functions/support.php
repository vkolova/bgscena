...
if ( !function_exists( 'implecode_support_menu' ) ):
	...
	function implecode_custom_support_menu() {
		?>
		<a id="support-settings" class="element" href="./edit.php?post_type=al_product&page=product-settings.php&tab=product-settings&submenu=support"><?php _e( 'Support', 'ecommerce-product-catalog' ); ?></a>
		<?php
	}
